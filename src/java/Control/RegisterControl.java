...
//        processRequest(request, response);
        ...
        if (UserDB.checkUserExist(username) == true) {
            ...
            url = "/RegisterNext.jsp";
            session.setAttribute("usernameRegister", username);
...
//        processRequest(request, response);
        ...
        request.setCharacterEncoding("utf-8");
        HttpSession session = request.getSession();
        String username = (String) session.getAttribute("usernameRegister");
...
//        session.setAttribute("user", user);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
        request.setCharacterEncoding("utf-8");
        if (request.getParameter("validateUser") != null) {
